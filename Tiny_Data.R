...
#Activity labels
al <- read.table("E:/UCI HAR Dataset/activity_labels.txt")[,2]
#Features
f <- read.table("E:/UCI HAR Dataset/features.txt")[,2]
...
#X_test data
X_test <- read.table("E:/UCI HAR Dataset/test/X_test.txt")
#Y_test data 
Y_test <- read.table("E:/UCI HAR Dataset/test/Y_test.txt")
#Subject_test data
ST <- read.table("E:/UCI HAR Dataset/test/subject_test.txt")
...
#X_train data
X_train <- read.table("E:/UCI HAR Dataset/train/X_train.txt")
#Y_train data
Y_train <- read.table("E:/UCI HAR Dataset/train/Y_train.txt")
#Subject_train data 
S_train <- read.table("E:/UCI HAR Dataset/train/subject_train.txt")
